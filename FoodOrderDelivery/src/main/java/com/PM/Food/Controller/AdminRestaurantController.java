...
import com.PM.Food.Response.MessageResoponse;
...
public class AdminRestaurantController {
    ...
    @DeleteMapping ("/{id}")
    public ResponseEntity<MessageResoponse> deleteRestaurant(@RequestHeader("Authorization") String jwt , @PathVariable Long id) throws Exception {


        User user = userService.findUserByJwtToken(jwt);
        restaurantService.deleteRestaurant(id);

        MessageResoponse res = new MessageResoponse();
